<template>
    <div class="d-flex flex-column vote-controls">
        ...
        <span class="votes-count">{{this.count}}</span>
...
export default { 
    ...
    computed: {
        classes(){
            return this.signedIn ? '' : 'off';// bien signedIn da duoc khai bao trong policies.js nen co the dung global
        },
        endpoint(){
    ...
    methods: {
        title(voteType){
            let titles = {
                ...
                down: `This ${ this.name } is usefull`
            };
